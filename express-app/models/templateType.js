...
var db = new dataStore({
	filename: path.join(__dirname, "..", "database" , "templateType.db"),
	autoload: true
});

var tableName = "templateType";

/** 
 * Table Column
 * @param {string} name The name of the type of template. I.E: "Trabajadores, Soporte y Servicio"
 **/
